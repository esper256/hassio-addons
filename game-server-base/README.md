...
Copy the block below into Cursor (or another frontier coding agent). Replace the placeholder in the first sentence with the official game name, a Steam store URL, dedicated-server docs, or all three.
