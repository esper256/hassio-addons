...
4. **Start** the app (first run downloads from Steam; can take several minutes — watch **Logs**)
...
**After a Factorio client patch** — with defaults, the app notices a newer Steam build and updates when empty. Confirm **OPEN WEB UI** shows a new build.
...
```text
/data/game/          # Steam install (bin/x64/factorio)
